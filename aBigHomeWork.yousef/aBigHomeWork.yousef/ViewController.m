...
- (void)viewDidLoad {
    ...
    timerLine =[NSTimer scheduledTimerWithTimeInterval:1.0
                                                target:self
...
-(void)timer{
    ...
    gameShom = [NSTimer scheduledTimerWithTimeInterval:1.0
                                                target:self
...
-(void)gamebuttone{
    ...
    moveIfDontClik =[NSTimer scheduledTimerWithTimeInterval:1.5
                                                     target:self
...
-(void)moveInNoClik{
    ...
    goToTimer = [NSTimer scheduledTimerWithTimeInterval:0.5
                                                 target:self
