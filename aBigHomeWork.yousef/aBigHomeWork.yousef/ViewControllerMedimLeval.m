...
#import "ViewControllerMedimLeval.h"
#import <AVFoundation/AVFoundation.h>


@interface ViewControllerMedimLeval ()

@end

@implementation ViewControllerMedimLeval
...
- (void)viewDidLoad {
    ...
    timerLine =[NSTimer scheduledTimerWithTimeInterval:0.6
                                                target:self
...
-(void)timer{
    ...
    gameShom = [NSTimer scheduledTimerWithTimeInterval:0.6
                                                target:self
...
-(void)createButtoneHome{
    NSLog(@"CreatHomeFlag");
    homeButtone = [[UIButton alloc]initWithFrame:CGRectMake(280,70,70,60)];
...
-(void)gamebuttone{
    ...
    moveIfDontClik =[NSTimer scheduledTimerWithTimeInterval:1.2
                                                     target:self
...
-(void)moveInNoClik{
    ...
    goToTimer = [NSTimer scheduledTimerWithTimeInterval:0.4
                                                 target:self
...
-(void)timerIm{
    ...
    [UIView animateWithDuration:35.0 animations:^ {
