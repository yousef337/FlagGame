...
#import "ViewControllerVeryHardLeval.h"

@interface ViewControllerVeryHardLeval ()

@end

@implementation ViewControllerVeryHardLeval
...
- (void)viewDidLoad {
    ...
    timerLine =[NSTimer scheduledTimerWithTimeInterval:0.2
                                                target:self
...
-(void)timer{
    ...
    gameShom = [NSTimer scheduledTimerWithTimeInterval:0.2
                                                target:self
...
-(void)gamebuttone{
    ...
    moveIfDontClik =[NSTimer scheduledTimerWithTimeInterval:0.6
                                                     target:self
